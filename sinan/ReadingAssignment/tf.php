...
function prepareContent() {
    ...
    countWords($words, $stop_words); //Solution A
    echo "<br/>";
    countWords2($book_text, $stop_words); //Solution B
}

function countWords($words, $stop_words) { //Solution A
    $list = array();
...
function countWords2($book_text, $stop_words) { //Solution B
