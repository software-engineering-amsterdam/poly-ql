...
import nl.uva.polyql.antlr4.QuestionnaireBaseListener;
...
public class QuestionnaireListener extends QuestionnaireBaseListener {
    ...
    @Override
    public void exitExpr_or(final nl.uva.polyql.antlr4.QuestionnaireParser.Expr_orContext ctx) {
        ctx.e.setLineInfo(new LineInfo(ctx));
    }
