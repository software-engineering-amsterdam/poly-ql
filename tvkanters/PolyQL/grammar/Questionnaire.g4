...
expr_sum[RuleContainer rc] returns [Expression e] :
	(left=expr_prod[$rc]{$e = $left.e;}) (op=OP_SUM right=expr_prod[$rc]{$e = OperationHelper.getOperationForOperands($e, $op.text, $right.e);} )* ;

expr_prod[RuleContainer rc] returns [Expression e] :
	(left=expr_atom[$rc]{$e = $left.e;}) (op=OP_PROD right=expr_atom[$rc]{$e = OperationHelper.getOperationForOperands($e, $op.text, $right.e);} )* ;
