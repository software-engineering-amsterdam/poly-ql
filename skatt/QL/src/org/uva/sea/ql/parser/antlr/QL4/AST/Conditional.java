...
public class Conditional extends Tree {
	 ...
	 */
	public Conditional(Tree ifCondition, List<Tree> elseifConditions, Tree ifStructure, List<Tree> elseifStructures, Tree elseStructure) {
