...
public interface QL4Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link QL4Parser#label}.
	 * @param ctx the parse tree
	 */
	void enterLabel(@NotNull QL4Parser.LabelContext ctx);
	/**
	 * Exit a parse tree produced by {@link QL4Parser#label}.
	 * @param ctx the parse tree
	 */
	void exitLabel(@NotNull QL4Parser.LabelContext ctx);
