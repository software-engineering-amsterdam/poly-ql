...
{
    public class GUIStringTextBox : GUIQuestion
    {
        private readonly TextBox _textBox;

        public GUIStringTextBox(QLMemory memory, string identifier, string label, bool isComputed = true)
        ...
        {
            Memory.DeclareValue(Identifier, new StringLiteral(_textBox.Text));
        ...
        public override void Render()
        {
            ...
            _textBox.Text = ((StringValue) Memory.GetDeclaredValue(Identifier).Evaluate()).GetValue();
        }
    }
}
