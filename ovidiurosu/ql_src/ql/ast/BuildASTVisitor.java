 ...
 * @author orosu
 */
public class BuildASTVisitor extends QLBaseVisitor<IElement>
{
    ...
    @Override
    public QuestionnaireList visitInitialize(@NotNull QLParser.InitializeContext ctx)
    {
    ...
    public Block visitBlock(@NotNull QLParser.BlockContext ctx)
    {
        ...
        for(QLParser.StatementContext statContext: ctx.statement()) {
            statements.add((IStatement) statContext.accept(this));
        }
    ...
    @Override
    public DecimalType visitMoneyType(@NotNull QLParser.MoneyTypeContext ctx)
    {
        return new DecimalType();
    }
    ...
    @Override
    public StringType visitTextType(@NotNull QLParser.TextTypeContext ctx)
    {
    ...
    public EnumType visitStringEnum(@NotNull QLParser.StringEnumContext ctx)
    {
        ...
        // Visit other enum elements
        EnumType otherEnumType = (EnumType) ctx.enumTypeP().accept(this);
        for (IEnumElement element: otherEnumType.getElements()) {
            enumType.addElement(element);
        }
        return enumType;
    }
    ...
    public RangeType visitIntegerRangeType(@NotNull QLParser.IntegerRangeTypeContext ctx)
    {
        return new RangeType(
            (IRangeElement) ctx.INT(0).accept(this),
            (IRangeElement) ctx.INT(1).accept(this)
        );
    }
    ...
    public BooleanLiteral visitBooleanLiteral(@NotNull QLParser.BooleanLiteralContext ctx)
    {
        ...
        return new BooleanLiteral(booleanValue.value);
    }
