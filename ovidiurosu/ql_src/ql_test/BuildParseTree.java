...
public class BuildParseTree extends ParserTest
{
    public BuildParseTree(File in, File out)
    {
        super(in, out);
    }
    ...
    public void testBuildParseTree()
    {
        ...
        try {
            ...
            //TODO BuildParseTree test on parts (for example: only expression -> not the whole form)
