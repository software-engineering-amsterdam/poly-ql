...
namespace Algebra.QL.Core.Factory
{
	public abstract class FactoryCombination<E1, S1, T1, E2, S2, T2, F1, F2>
        : Algebra.Core.Factory.FactoryCombination<E1, S1, T1, E2, S2, T2, F1, F2>,
		...
		where F2 : IFactory<E2, S2, T2>
	{
        ...
        public Tuple<T1, T2> StringType()
        {
            return new Tuple<T1, T2>(Factory1.StringType(), Factory2.StringType());
        }

        public Tuple<T1, T2> IntType()
        {
            return new Tuple<T1, T2>(Factory1.IntType(), Factory2.IntType());
        }

        public Tuple<T1, T2> RealType()
        {
            return new Tuple<T1, T2>(Factory1.RealType(), Factory2.RealType());
        }

        public Tuple<T1, T2> BoolType()
        {
            return new Tuple<T1, T2>(Factory1.BoolType(), Factory2.BoolType());
        }
        ...
        public Tuple<E1, E2> NegateBool(Tuple<E1, E2> e)
        {
            return new Tuple<E1, E2>(Factory1.NegateBool(e.Item1), Factory2.NegateBool(e.Item2));
        }

		public Tuple<E1, E2> NegateNumeric(Tuple<E1, E2> e)
		{
			return new Tuple<E1, E2>(Factory1.NegateNumeric(e.Item1), Factory2.NegateNumeric(e.Item2));
		}

		public Tuple<E1, E2> VarDecl(string var, Tuple<T1, T2> t)
		{
			return new Tuple<E1, E2>(Factory1.VarDecl(var, t.Item1), Factory2.VarDecl(var, t.Item2));
		}

		public Tuple<E1, E2> VarAssign(string var, Tuple<T1, T2> t, Tuple<E1, E2> e)
		{
			return new Tuple<E1, E2>(Factory1.VarAssign(var, t.Item1, e.Item1), Factory2.VarAssign(var, t.Item2, e.Item2));
		}
		...
		public Tuple<S1, S2> Question(string s, Tuple<E1, E2> e)
		{
			return new Tuple<S1, S2>(Factory1.Question(s, e.Item1), Factory2.Question(s, e.Item2));
		}

        public Tuple<S1, S2> Label(string s, Tuple<E1, E2> e)
        {
            return new Tuple<S1, S2>(Factory1.Label(s, e.Item1), Factory2.Label(s, e.Item2));
        }
