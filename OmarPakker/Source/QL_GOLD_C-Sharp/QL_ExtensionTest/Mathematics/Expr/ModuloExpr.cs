...
{
    public class ModuloExpr : DoubleExprNode<ITypeCheckExpr>, ITypeCheckExpr
    {
        ...
        public IEnumerable<Tuple<string, bool>> CheckTypesValid()
        {
            ...
            {
                yield return new Tuple<string, bool>(String.Format("Modulo not possible. Incompatible types: '{0}', '{1}'. Only numeric types are supported.",
